...
djinny.login()
r = djinny.get_authenticated_page("https://djinni.co/my/inbox/")

print(r.text[:500]) if r else print("Failed to retrieve authenticated page")

exit()

# Initialize Auth class
robota_auth = Auth(session=session, 
            api_headers=touch_api_header, 
            username=USERNAME, password=PASSWORD, 
            touch_url="https://djinni.co/",
